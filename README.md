...
# 프로젝트
  1. ## *악성코드분석 프로그램*
       ...
       - 역할: PE 파일 데이터 전처리 파이프라인 구축, FastAPI 기반 업데이트 서버 설계 및 구, 클라이언트 설정창 제작, 머신러닝 알고리즘 학습
       - ### 트러블슈팅
           1. 
   2. ## *패킷관제 프로그램*
       ...
       - 사용언어: Java
       - 기술 스택: JnetPcap, JacaFX
       - 프로그램 구조:
         네트워크 인터페이스 → 패킷 캡처 → 패킷 파싱 → 데이터 처리 → UI 출력
       - 역할: 인터넷 포트에서 송수신 되는 패킷들의 일부 정보를 추출하여 실시간으로 보여주는 기능 제작
